...
class Deck {
	...
	for (int i=0; i<cards.length; i++) {
		...
		//fixed a bug in the code. randInt generates random numbers from low to high exclusive. 
		//In above statement the final card was being ignored, so I fixed it by making high index as length
		//Below commented code  will force King of Spades to always be the last card
